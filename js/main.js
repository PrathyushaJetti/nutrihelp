...
$(document).ready(function() {
    var e = '<div class="prt_floting_customsett">'+
                '<a href="https://wa.me/+918125043330?text=hii" class="tmtheme_fbar_icons"><i class="fa fa-whatsapp"></i><span>ConnectUs</span></a>'+
                '<a href="https://www.instagram.com/asnutrihelp?igsh=MTh4eXVteWk5bGhpZQ==" class="tmtheme_fbar_icons"><i class="fa fa-instagram"></i><span>FollowUs</span></a>'+
                '<a href="https://www.youtube.com/@ASNUTRIHELP" class="tmtheme_fbar_icons"><i class="fa fa-youtube"></i><span class="buy_link">SubscribeUs <span></span></span></a>'+
